...
if __name__ == '__main__':
    ...
    parser.add_argument('--residual', type=eval, help='Determines whether the diffusion model should add the estimated difference to the original input to get the output or should estimate the ouput directly (default: True)' ,choices=[True, False], default=True)
    parser.add_argument('--truncate_std', type=float, help='sample prior from a truncated Gaussian with with mean determined via this argument (default 2.0)', default=2.0)
